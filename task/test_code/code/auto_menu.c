...
void UNIT_SET(){
	//菜单单元调参参数初始化
    unit_param_set(&test_a,TYPE_FLOAT ,0.5  ,3  ,3,NORMAL_PAR,"p");
    unit_param_set(&test_b,TYPE_INT   ,2    ,6  ,0,NORMAL_PAR,"i");
    unit_param_set(&test_c,TYPE_DOUBLE,11.11,4  ,4,NORMAL_PAR,"d");
